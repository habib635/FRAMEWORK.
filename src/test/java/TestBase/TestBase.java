...
public class TestBase {
	...
	public TestBase() throws Exception {
		...
		ip = new FileInputStream(System.getProperty("user.dir")
				+ "\\eclipse-workspace\\hybrid_framework_3\\config.properties");
		prop.load(ip);
		// /hybrid_framework_3/src/main/java/utilities/util.java
		dataProp = new Properties();
		ip = new FileInputStream(System.getProperty("user.dir")
				+ "\\src\\test\\java\\com\\hybrid_framework_3\\TestData\\testData.properties");
		dataProp.load(ip);
	}
